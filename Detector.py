...
detector = YOLOV5_Detector(weights='banana_classification.pt',
                           img_size=416,
...
img = cv2.imread("banana (151).JPG")
img = cv2.imread("banana (152).JPG")
img = cv2.imread("damaged_banana (152).JPG")
img = cv2.imread("damaged_banana (152).JPG")
detector.Detect(img)